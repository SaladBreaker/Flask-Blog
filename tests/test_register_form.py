...
def test_register_unsuccesful_for_missing_confirm_password(new_user,configed_app,client):
	with configed_app.test_request_context():
		response = client.post(
			'register',
			data = dict(
...
def test_register_unsuccesful_for_different_pass_and_conf_pass(new_user,configed_app,client):
	with configed_app.test_request_context():
		response = client.post(
			'register',
			data = dict(
